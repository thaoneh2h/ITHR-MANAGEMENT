                    ...
                    <div class="col  rounded careers-table" data-aos="fade-left">
                        ...
                        <div class="card border-0 mb-3">
                         ...
                         <div class="card border-0 mb-3">
                             ...
                             <div class="card-body d-flex justify-content-between full-width align-items-center">
                                 <div class="full-width">
                                    <h6 class="card-subtitle mb-2 text-secondary">CounsinTech</h6>
                                    <h4>Front-end Recruitment</h4> 
                                </div>
                                <a href="#" onclick="goToDestination('front-end')">
                                    <button class="btn btn-primary">
                                        Apply
                                    </button>
                                </a>
                        ...
                        <div class="card border-0 mb-3">
                            ...
                            <div class="card-body d-flex justify-content-between full-width align-items-center">
                                <div class="full-width">
                                    <h6 class="card-subtitle mb-2 text-secondary">CounsinTech</h6>
                                    <h4>Marketing Recruitment</h4> 
                                </div>
                                <a href="#" onclick="goToDestination('marketing')">
                                    <button class="btn btn-primary">
                                        Apply
                                    </button>
                                </a>
                        ...
                        <div class="card border-0 mb-3">
                            <div class="card-body d-flex justify-content-between full-width align-items-center">
                                <div class="full-width">
                                    <h6 class="card-subtitle mb-2 text-secondary">CounsinTech</h6>
                                    <h4>Project Manager Recruitment</h4> 
                                </div>
                                <a href="#" onclick="goToDestination('productManager')">
                                    <button class="btn btn-primary">
                                        Apply
                                    </button>
                                </a>
