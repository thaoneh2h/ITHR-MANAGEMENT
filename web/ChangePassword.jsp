        ...
        <section class="pt-16 sm:ml-64">
            ...
            <div class="p-10 rounded-lg flex justify-center">
                ...
                <div class="w-1/3 items-center flex  flex-col rounded-xl p-5 overflow-hidden relative"
                    ...
                    <form class="position-relative w-full" action="ChangePasswordController" method="POST">
                        <div class="mb-3">
                            ...
                            <input type="password"
                                   ...
                                   id="password" name="txtCurrentPassword" placeholder="Current Password">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password"
                                   class=" border text-sm rounded-lg block w-full p-2.5  border-gray-600 placeholder-gray-400  ring-blue-500 focus:border-blue-500"
                                   id="password" name="txtNewPassword" placeholder="New Password">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password"
                                   class=" border text-sm rounded-lg  block w-full p-2.5  border-gray-600 placeholder-gray-400 ring-blue-500 focus:border-blue-500"
                                   id="confPassword" name="txtConfirm" placeholder="Confirm Password">
