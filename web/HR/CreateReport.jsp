					...
					>
						<div class="w-full">
							<form
								...
								action="/HRManagement/MainController"
							>
								<div class="mb-3">
								...
								<div class="relative mb-3 w-full">
									...
									>
										<c:if test="${not empty LIST_DEPARTMENT_EMPLOYEE}">
											<c:forEach
												var="dto"
												items="${requestScope.LIST_DEPARTMENT_EMPLOYEE}"
											>
												<option value="${dto.employee_id}">
													${dto.employee_name}-${dto.employee_id}
												</option>
											</c:forEach>
										</c:if>
										<c:if test="${not empty LIST_DEPARTMENT_EMPLOYEE2}">
											<c:forEach
												var="dto"
												items="${requestScope.LIST_DEPARTMENT_EMPLOYEE2}"
											>
												<option value="${dto.employee_id}">
													${dto.employee_name}-${dto.employee_id}
												</option>
